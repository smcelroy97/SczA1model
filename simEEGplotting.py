...
batch = 'Scz_tune_0410' #Name of batch for fig saving
...
for file in os.listdir(base_dir):
    if file.endswith('.pkl'):
        ...
        fname = file[0:12] # Create filename (can change to whatever)
        ...
        # stim_data, stim_window = simTools.calculateEEG(sim, stimOn=2800, end=6000) # Generate EEG data from dipole sums
        # filtered_data = simTools.filterEEG(stim_data, 2, 80, 20000, 2) # Filter (if needed)
